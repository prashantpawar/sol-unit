...
declare -a TestContracts=('ArrayTest.sol' 'Bank.sol' 'BankTest.sol' 'BasicTypesTest.sol' 'CoinTest.sol' 'DemoTest.sol' 'EthTest.sol' 'LibTest.sol' 'GlobalsTest.sol' 'IndirectionTest.sol' 'StructsTest.sol' 'ThrowerTest.sol' 'WrapsInternalTest.sol')
