 ...
 */
SUnit.prototype.start = function (tests, baseDir, testBalance) {
    this._baseDir = baseDir;
    this._tests = tests;
    this._stats = {testUnits: {}, skippedUnits: {}};
    this._testBalance = testBalance;
...
SUnit.prototype.runContract = function () {
    ...
    var test = new TestRunner(testName, bin, abi, new Program(this._baseDir, this._testBalance));
